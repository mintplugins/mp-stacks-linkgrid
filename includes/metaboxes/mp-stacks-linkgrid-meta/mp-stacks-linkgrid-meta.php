...
function mp_stacks_linkgrid_create_meta_box(){
	...
	$mp_stacks_linkgrid_items_array = array(
		...
		//Bg animation stuff
		'linkgrid_bg_color_settings' => array(
			'field_id'			=> 'linkgrid_bg_color_settings',
			...
			'linkgrid_bg_color_animation_repeater_title' => array(
				'field_id'			=> 'linkgrid_bg_color_animation_repeater_title',
				'field_title' 	=> __( 'KeyFrame', 'mp_stacks_linkgrid'),
				'field_description' 	=> NULL,
				'field_type' 	=> 'repeatertitle',
				'field_repeater' => 'linkgrid_bg_color_animation_keyframes',
				'field_showhider' => 'linkgrid_bg_color_settings',
			),
			'linkgrid_bg_color_animation_length' => array(
			...
			'linkgrid_bg_color_animation_backgroundColorAlpha' => array(
			...
			'linkgrid_bg_color_animation_color' => array(
			...
			'linkgrid_bg_color_animation_rotation' => array(
				'field_id'			=> 'rotateZ',
			...
			'linkgrid_bg_color_animation_x' => array(
				'field_id'			=> 'translateX',
			...
			'linkgrid_bg_color_animation_y' => array(
				'field_id'			=> 'translateY',
			...
			'linkgrid_bg_color_animation_scale' => array(
				'field_id'			=> 'scale',
...
add_action('mp_brick_metabox', 'mp_stacks_linkgrid_create_meta_box');