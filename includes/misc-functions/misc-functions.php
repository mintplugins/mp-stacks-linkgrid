...
/**
 * Make LinkGrid Content Type Centered by default
 *
 * @access   public
 * @since    1.0.0
 ...
 * @param    $centered_content_types array - An array containing a string for each content-type that should default to centered brick alignment.
 */
function mp_stacks_linkgrid_centered_by_default( $centered_content_types ){
	
	$centered_content_types['linkgrid'] = 'linkgrid';
	
	return $centered_content_types;
	
}
add_filter( 'mp_stacks_centered_content_types', 'mp_stacks_linkgrid_centered_by_default' );