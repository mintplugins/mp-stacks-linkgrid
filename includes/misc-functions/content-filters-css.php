...
function mp_stacks_brick_content_output_css_linkgrid( $css_output, $post_id, $first_content_type, $second_content_type ){
	...
	mp_stacks_grids_enqueue_frontend_css( 'linkgrid' );
	...
	#mp-brick-' . $post_id . ' .mp-stacks-grid-item{' . 
			...
			mp_core_css_line( 'width', mp_stacks_grid_posts_per_row_percentage( $linkgrid_per_row ), '%' ) . 
	...
	$css_output .= mp_stacks_grid_overlay_mobile_css( $post_id, 'linkgrid_image_overlay_animation_keyframes', 'linkgrid' );
