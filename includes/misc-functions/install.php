<?php
/**
 * Installaion hooks for MP Stacks + LinkGrid
 *
 ...
 * @since 1.0
 * @global $wpdb
 * @global $mp_stacks_linkgrid_options
 * @global $wp_version
 * @return void
 */
function mp_stacks_linkgrid_install() {
	global $wp_version, $mp_stacks_linkgrid_activation;
	...
	wp_remote_post( 'http://tracking.mintplugins.com', array(
		...
		'body' => array( 
			'mp_track_event' => true, 
			'event_product_title' => 'MP Stacks + LinkGrid', 
 ...
 * @since 1.0
 * @global $wpdb
 * @global $mp_stacks_linkgrid_activation
 * @return void
 */
function mp_stacks_linkgrid_activation_shutdown(){
	
	global $mp_stacks_linkgrid_activation;
	
	if ( $mp_stacks_linkgrid_activation ){
		//Flush the rewrite rules
		flush_rewrite_rules();
	}
	
}
add_action( 'shutdown', 'mp_stacks_linkgrid_activation_shutdown' );